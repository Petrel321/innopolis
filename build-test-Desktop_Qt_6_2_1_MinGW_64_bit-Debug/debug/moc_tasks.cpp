...
QT_MOC_LITERAL(6, 7), // "account"
QT_MOC_LITERAL(14, 0), // ""
QT_MOC_LITERAL(15, 15), // "load_task_types"
QT_MOC_LITERAL(31, 13), // "tasks_clicked"
QT_MOC_LITERAL(45, 36), // "on_comboBox_task_types_textAc..."
QT_MOC_LITERAL(82, 4) // "arg1"

    },
    "tasks\0account\0\0load_task_types\0"
    "tasks_clicked\0on_comboBox_task_types_textActivated\0"
    "arg1"
};
...
void tasks::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->load_task_types(); break;
        case 2: _t->tasks_clicked(); break;
        case 3: _t->on_comboBox_task_types_textActivated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (tasks::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&tasks::account)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<tasks, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
